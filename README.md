...
1. 日志文件存储目录
   ...
   日志会存储到 tomcat 安装目录上两级文件夹中的 client_attendance 文件夹
...
(三) java 8 的安装和配置
   ...
   1. 请选择合适的 jdk 版本下载
   2. jdk下载地址: [点我下载](https://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html)
   3. 如下载过慢, 可以选择百度网盘下载: [地址](https://pan.baidu.com/s/1CSSGoGnVOTIAf7RCqsEA1g) 密码:taai
   4. 下载完成后需添加环境变量
   5. 后面暂时略, 如有需要, 后续补充
